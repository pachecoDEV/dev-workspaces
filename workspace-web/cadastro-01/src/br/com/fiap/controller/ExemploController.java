 ...
 */
@WebServlet(
		description = "Controle de acesso e fluxo de informacoes.", urlPatterns = {"/exemplo"})
...
public class ExemploController extends HttpServlet {
    ...
    public ExemploController() {
        ...
        if (lista == null) {
        	...
        	//Criando um instancia de Cliente
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Adicionando a lista em um atributo no request utilizando o metodo setAttribute(nomeAtributo, Objeto)
		request.setAttribute("listaCli", lista);
		
		//ENCAMINHAMENTO DO REQUEST/RESPONSE - IN�CIO
		
		//Criar o dispatcher atraves da interface RequestDispatcher e passa para ela a URI/URL de destino
		RequestDispatcher rd = request.getRequestDispatcher("lista.jsp");
		
		//Utilizando o metodo forward nos passamos o request e o response finalmente
